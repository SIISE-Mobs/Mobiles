...
class _PaiementScreenState extends State<PaiementScreen> {
  ...
  loadPaiementData() async {
    cibleList = dbHelper!.getCiblesPaiement();
    var region =
  ...
  void _searchDatas(String cin) async {
    cibleList = dbHelper!.getCiblesPaiementCin(cin);
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "CIBLES NON PAYES ::: REGION $regionStr",
          style: TextStyle(
            fontSize: 16,
            ...
            child: FutureBuilder(
              ...
              builder:
                ...
                if (!snapshot.hasData || snapshot.data == null) {
                  ...
                  return Center(
                    child: Text(
                      "Pas de cibles non payés dans la Région",
                      style: TextStyle(
                        fontSize: 16,
