// ignore_for_file: file_names, prefer_const_constructors, no_leading_underscores_for_local_identifiers, prefer_const_literals_to_create_immutables, use_build_context_synchronously, deprecated_member_use
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Padding(
              ...
              child: Text(
                'Rafitra Informatika ho fanaraha-maso sy fanombanana'
                    .toUpperCase(),
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 14.0,
